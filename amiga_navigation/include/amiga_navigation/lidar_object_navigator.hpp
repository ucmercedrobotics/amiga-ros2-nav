...
#include "amiga_navigation_interfaces/action/navigate_to_object.hpp"
...
class LidarObjectNavigator : public rclcpp::Node {
 public:
  ...
  using NavigateToObject =
      amiga_navigation_interfaces::action::NavigateToObject;
  using GoalHandleNavigateToObject =
      rclcpp_action::ServerGoalHandle<NavigateToObject>;
